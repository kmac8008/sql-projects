...
Which items are popular for takeaway but not in-store?
What day generates the highest sales?
...
Use a more complicated dataset that require joining multiple files together
